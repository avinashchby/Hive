---
name: hive-new
description: Greenfield project bootstrapper with memory-informed architecture. Designs stack from prior decisions, scaffolds files, seeds long-term memory. Use for new projects from scratch.
